from src.model.stochastic import SankST
...
if __name__ == '__main__':
    ...
    random_seed = 0
    x_lb = np.array([-1, -1, -1, -1])
    x_ub = np.array([1, 1, 1, 1])
    prob.set_options(degree=2, x_lb=x_lb, x_ub=x_ub,
    ...
    safe_set = Ellipsoid([0, 0, 0, 0], [1, 1, 1, 1])
